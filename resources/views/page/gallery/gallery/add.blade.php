...
<div class="col-12">	
	<div class="box box-default">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form method="post" action="admin/news/news/add">
             {{ csrf_field() }}             
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input class="form-control" type="text" value="{{old('id')}}" name="id" placeholder="Mã tin tức">
                    </div>
                    <div class="col-sm-2">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    $('form').on('click','.iCheck-helper',function(){
        alert("XXXX");
    });
});
{{--  Muti Upload  --}}
