	...
	<div class="box">
		...
		<div class="box-body">
			<div class="box_button_table">	
				<a class="btn btn-app bg-blue" href="admin/user/account/add">
			...
			<div class="dataTables_wrapper">			
				<table id="table_responsive"  class="table table-bordered table-hover display nowrap margin-top-10 table-responsive dataTable" role="grid" >
					...
					<tbody>
						...
						@foreach($list_account as $key => $item)
                        <tr role="row" class="odd">
                            ...
                            <td class="action_tablel">           
								<a href="admin/user/account/edit/{{$item->id}}">
									<span class="label bg-aqua">
										Thay đổi
										<i class="fa fa-pencil"></i>
									</span> 
								</a>
								<a href="admin/user/account/delete/{{$item->id}}">
...
<?php
$excel = Config::get('constants.file.excel.account.category');
?>
	<!-- DataTables -->
