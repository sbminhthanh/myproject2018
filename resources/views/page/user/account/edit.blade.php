...
<div class="col-12">	
	<div class="box box-default">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form method="post" action="admin/user/account/edit/{{$product->id}}">
             {{ csrf_field() }}             
                  ...
                  <div id="tab_element" class="tab_editor">
                    <ul class="resp-tabs-list tab_element ">
                        ...
                        @if(!empty(old('option_tab')))
                          ...
                          @endforeach
                        @else
                          @foreach($product->product_tab as $key => $value)
                 ...
                 {{--  SEO  --}}
                  <div class="box-header ">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input class="form-control" type="text" id="seo_title" placeholder="SEO title" value="@if(empty(old('seo_title'))){{$product->seo_title}}@else{{old('seo_title')}}@endif" name="seo_title">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="seo_slug" class="col-sm-2 col-form-label">Slug:</label>
                        <div class="col-sm-10">
                          <input class="form-control" type="text" id="seo_slug" placeholder="Slug" value="@if(empty(old('seo_slug'))){{$product->slug}}@else{{old('seo_slug')}}@endif" name="seo_slug">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="meta_description" class="col-sm-2 col-form-label">Meta Description:</label>
                        <div class="col-sm-10">
                          <textarea name="meta_description" id="meta_description" class="form-control" placeholder="Meta Description" >@if(empty(old('meta_description'))){{$product->meta_description}}@else{{old('meta_description')}}@endif</textarea>   
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="focus_keyword" class="col-sm-2 col-form-label">Focus Keyword:</label>
                        <div class="col-sm-10">
                          <input class="form-control" type="text" id="focus_keyword" placeholder="Focus Keyword" value="@if(empty(old('focus_keyword'))){{$product->focus_keyword}}@else{{old('focus_keyword')}}@endif" name="focus_keyword">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="meta_keyword" class="col-sm-2 col-form-label">Meta Keyword:</label>
                        <div class="col-sm-10">
                          <input class="form-control" type="text" id="meta_keyword" placeholder="Meta Keyword" value="@if(empty(old('meta_keyword'))){{$product->meta_keyword}}@else{{old('meta_keyword')}}@endif" name="meta_keyword">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="meta_title" class="col-sm-2 col-form-label">Meta Title:</label>
                        <div class="col-sm-10">
                          <input class="form-control" type="text" id="meta_title" placeholder="Meta Title" value="@if(empty(old('meta_title'))){{$product->meta_title}}@else{{old('meta_title')}}@endif" name="meta_title">
                        </div>
                      </div>                    
                    </div>
                 {{--  Button  --}}
