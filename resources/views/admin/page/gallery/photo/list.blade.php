	...
	<div class="box">
		...
		<div class="box-body">
			<div class="box_button_table">	
				<a class="btn btn-app bg-blue" href="admin/news/category/add">
			...
			<div class="dataTables_wrapper">			
				<table id="table_responsive"  class="table table-bordered table-hover display nowrap margin-top-10 table-responsive dataTable" role="grid" >
					...
					<tbody>
						@foreach($news_category as $key => $item)
                        <tr role="row" class="odd">
                            ...
                            <td class="action_tablel">           
								<a href="admin/news/category/edit/{{$item->id}}">
									<span class="label bg-aqua">
										Thay đổi
										<i class="fa fa-pencil"></i>
									</span> 
								</a>
								<a href="admin/news/category/delete/{{$item->id}}">
