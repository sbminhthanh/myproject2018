	...
	<div class="box">
		...
		<div class="box-body">
			<div class="box_button_table">	
				<a class="btn btn-app bg-blue" href="admin/product/product/add">
				...
				<table id="table_responsive"  class="table table-bordered table-hover display nowrap margin-top-10 table-responsive dataTable" role="grid" >
					...
					<tbody>
                        ...
                        <tr role="row" class="odd">
							...
							<td class="sorting_1">{{$item->product_id}}</td>
							<td>
								{{$item->product_category->category_name}}</br>
								|___{{$item->product_title}}
							</td>							
							<td class="item_check">
								@if($item->sticky==1)
                            ...
                            <td class="action_tablel">           
								<a href="admin/product/product/edit/{{$item->id}}">
									<span class="label bg-aqua">
										Thay đổi
										<i class="fa fa-pencil"></i>
									</span> 
								</a>
								<a href="admin/product/product/delete/{{$item->id}}">
